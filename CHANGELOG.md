...
* **sandbox:** env_deny list by exact name; emit XDG_RUNTIME_DIR only when a bind reaches it ([78b9d82](https://github.com/willow-memory/kartikeya/commit/78b9d823ab99d4079e96ceef8462cde69061c8c2))

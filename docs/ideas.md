...
17. Adopt `Idea-Id` commit trailers (fleet CONVENTION, decision-2026-09-11): `.github/workflows/trailers.yml` runs `reconciler verify` on every push and pull request to `master`, and `CONTRIBUTING.md` carries the convention and the commands that emit a trailer.
